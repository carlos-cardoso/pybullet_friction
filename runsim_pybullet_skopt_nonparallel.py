...
PYBULLET_INSTANCE = p.DIRECT#p.GUI
WATCHDOG = True
PLOTTING = False
...
def load_robot(toolname):
  ...
  #toolId = p.loadURDF("{}.urdf".format(toolname))
  print(toolname)
...
if __name__ == "__main__":
  ...
  for obj in object_name:
    #fname = "saved/gp_fixed_yball_0.7700822829304974.bz2"#"saved/gp_fixed_{}_{}.bz2".format(obj, randn)
    fname = "saved/gp_fixed_{}.bz2".format(obj)
    #fname = "saved/gp_fixed_ylego_0.7427908406887576.bz2"
